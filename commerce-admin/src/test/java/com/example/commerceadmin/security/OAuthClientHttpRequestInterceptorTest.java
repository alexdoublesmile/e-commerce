...
class OAuthClientHttpRequestInterceptorTest {
    ...
    OauthClientRequestInterceptor interceptor;

    @BeforeEach
    void setUp() {
        interceptor = new OauthClientRequestInterceptor(authorizedClientManager, "test");
    }
    ...
    void intercept_AuthorizationHeaderIsNotSet_AddsAuthorizationHeader() throws IOException {
        ...
        var authentication = new TestingAuthenticationToken("w.addams", "password");
        SecurityContextHolder.getContext().setAuthentication(authentication);

        var authorizedClient = new OAuth2AuthorizedClient(mock(), "w.addams",
